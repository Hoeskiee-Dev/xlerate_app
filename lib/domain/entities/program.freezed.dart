...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,title,description,host,speaker,startDate,endDate,time,locationType,location,tag,const DeepCollectionEquality().hash(skills),eligibility,isFree,fee,offersCertificate,offersBadge,offersMicroScholarships,offersLetterOfRecommendation,offersPhysicalSwags,offersXleratePoints,xpAmount,extraReward,imageUrl,imageFile,totalSeats,joinedCount,feedbackForm,registrationDeadLine]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,title,description,host,speaker,startDate,endDate,time,locationType,location,tag,const DeepCollectionEquality().hash(_skills),eligibility,isFree,fee,offersCertificate,offersBadge,offersMicroScholarships,offersLetterOfRecommendation,offersPhysicalSwags,offersXleratePoints,xpAmount,extraReward,imageUrl,imageFile,totalSeats,joinedCount,feedbackForm,registrationDeadLine]);
