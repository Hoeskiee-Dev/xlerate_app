...
mixin _$Program {
 ...
 String get title; String get description; String get host; String? get speaker; String get startDate; String? get endDate; String get time; String get locationType; String get location; String get tag; List<String> get skills; String get eligibility; bool get isFree; double get fee; bool get offersCertificate; bool get offersBadge; bool get offersMicroScholarships; bool get offersLetterOfRecommendatiom; bool get offersPhysicalSwags; bool get offersXleratePoints; int? get xpAmount; String? get extraReward; String get imageUrl;@JsonKey(includeFromJson: false, includeToJson: false) File? get imageFile; int? get totalSeats; int get joinedCount; SavedFeedbackForm? get feedbackForm; String? get registrationDeadLine;
...
@useResult
$Res call({
 String title, String description, String host, String? speaker, String startDate, String? endDate, String time, String locationType, String location, String tag, List<String> skills, String eligibility, bool isFree, double fee, bool offersCertificate, bool offersBadge, bool offersMicroScholarships, bool offersLetterOfRecommendatiom, bool offersPhysicalSwags, bool offersXleratePoints, int? xpAmount, String? extraReward, String imageUrl,@JsonKey(includeFromJson: false, includeToJson: false) File? imageFile, int? totalSeats, int joinedCount, SavedFeedbackForm? feedbackForm, String? registrationDeadLine
});
...
as bool,offersLetterOfRecommendatiom: null == offersLetterOfRecommendatiom ? _self.offersLetterOfRecommendatiom : offersLetterOfRecommendatiom // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String description,  String host,  String? speaker,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendatiom,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  int joinedCount,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.title,_that.description,_that.host,_that.speaker,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendatiom,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.joinedCount,_that.feedbackForm,_that.registrationDeadLine);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String description,  String host,  String? speaker,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendatiom,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  int joinedCount,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine)  $default,) {final _that = this;
switch (_that) {
case _Program():
return $default(_that.title,_that.description,_that.host,_that.speaker,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendatiom,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.joinedCount,_that.feedbackForm,_that.registrationDeadLine);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String description,  String host,  String? speaker,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendatiom,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  int joinedCount,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine)?  $default,) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.title,_that.description,_that.host,_that.speaker,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendatiom,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.joinedCount,_that.feedbackForm,_that.registrationDeadLine);case _:
  return null;
...
@override final  bool offersLetterOfRecommendatiom;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,title,description,host,speaker,startDate,endDate,time,locationType,location,tag,const DeepCollectionEquality().hash(_skills),eligibility,isFree,fee,offersCertificate,offersBadge,offersMicroScholarships,offersLetterOfRecommendatiom,offersPhysicalSwags,offersXleratePoints,xpAmount,extraReward,imageUrl,imageFile,totalSeats,joinedCount,feedbackForm,registrationDeadLine]);
...
/// Create a copy of Program
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? description = null,Object? host = null,Object? speaker = freezed,Object? startDate = null,Object? endDate = freezed,Object? time = null,Object? locationType = null,Object? location = null,Object? tag = null,Object? skills = null,Object? eligibility = null,Object? isFree = null,Object? fee = null,Object? offersCertificate = null,Object? offersBadge = null,Object? offersMicroScholarships = null,Object? offersLetterOfRecommendatiom = null,Object? offersPhysicalSwags = null,Object? offersXleratePoints = null,Object? xpAmount = freezed,Object? extraReward = freezed,Object? imageUrl = null,Object? imageFile = freezed,Object? totalSeats = freezed,Object? joinedCount = null,Object? feedbackForm = freezed,Object? registrationDeadLine = freezed,}) {
