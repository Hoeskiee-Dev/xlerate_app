...
mixin _$Program {
 ...
 String? get id; String get title; String get description; String get host; String? get speaker; String? get url; String get startDate; String? get endDate; String get time; String get locationType; String get location; String get tag; List<String> get skills; String get eligibility; bool get isFree; double get fee; bool get offersCertificate; bool get offersBadge; bool get offersMicroScholarships; bool get offersLetterOfRecommendation; bool get offersPhysicalSwags; bool get offersXleratePoints; int? get xpAmount; String? get extraReward; String get imageUrl;@JsonKey(includeFromJson: false, includeToJson: false) File? get imageFile; int? get totalSeats; SavedFeedbackForm? get feedbackForm; String? get registrationDeadLine;@JsonKey(defaultValue: []) List<String> get joinedUserIds;
...
@useResult
$Res call({
 String? id, String title, String description, String host, String? speaker, String? url, String startDate, String? endDate, String time, String locationType, String location, String tag, List<String> skills, String eligibility, bool isFree, double fee, bool offersCertificate, bool offersBadge, bool offersMicroScholarships, bool offersLetterOfRecommendation, bool offersPhysicalSwags, bool offersXleratePoints, int? xpAmount, String? extraReward, String imageUrl,@JsonKey(includeFromJson: false, includeToJson: false) File? imageFile, int? totalSeats, SavedFeedbackForm? feedbackForm, String? registrationDeadLine,@JsonKey(defaultValue: []) List<String> joinedUserIds
});
...
/// Create a copy of Program
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? host = null,Object? speaker = freezed,Object? url = freezed,Object? startDate = null,Object? endDate = freezed,Object? time = null,Object? locationType = null,Object? location = null,Object? tag = null,Object? skills = null,Object? eligibility = null,Object? isFree = null,Object? fee = null,Object? offersCertificate = null,Object? offersBadge = null,Object? offersMicroScholarships = null,Object? offersLetterOfRecommendation = null,Object? offersPhysicalSwags = null,Object? offersXleratePoints = null,Object? xpAmount = freezed,Object? extraReward = freezed,Object? imageUrl = null,Object? imageFile = freezed,Object? totalSeats = freezed,Object? feedbackForm = freezed,Object? registrationDeadLine = freezed,Object? joinedUserIds = null,}) {
...
as String?,joinedUserIds: null == joinedUserIds ? _self.joinedUserIds : joinedUserIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
/// Create a copy of Program
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String title,  String description,  String host,  String? speaker,  String? url,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendation,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine, @JsonKey(defaultValue: [])  List<String> joinedUserIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.host,_that.speaker,_that.url,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendation,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.feedbackForm,_that.registrationDeadLine,_that.joinedUserIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String title,  String description,  String host,  String? speaker,  String? url,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendation,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine, @JsonKey(defaultValue: [])  List<String> joinedUserIds)  $default,) {final _that = this;
switch (_that) {
case _Program():
return $default(_that.id,_that.title,_that.description,_that.host,_that.speaker,_that.url,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendation,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.feedbackForm,_that.registrationDeadLine,_that.joinedUserIds);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String title,  String description,  String host,  String? speaker,  String? url,  String startDate,  String? endDate,  String time,  String locationType,  String location,  String tag,  List<String> skills,  String eligibility,  bool isFree,  double fee,  bool offersCertificate,  bool offersBadge,  bool offersMicroScholarships,  bool offersLetterOfRecommendation,  bool offersPhysicalSwags,  bool offersXleratePoints,  int? xpAmount,  String? extraReward,  String imageUrl, @JsonKey(includeFromJson: false, includeToJson: false)  File? imageFile,  int? totalSeats,  SavedFeedbackForm? feedbackForm,  String? registrationDeadLine, @JsonKey(defaultValue: [])  List<String> joinedUserIds)?  $default,) {final _that = this;
switch (_that) {
case _Program() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.host,_that.speaker,_that.url,_that.startDate,_that.endDate,_that.time,_that.locationType,_that.location,_that.tag,_that.skills,_that.eligibility,_that.isFree,_that.fee,_that.offersCertificate,_that.offersBadge,_that.offersMicroScholarships,_that.offersLetterOfRecommendation,_that.offersPhysicalSwags,_that.offersXleratePoints,_that.xpAmount,_that.extraReward,_that.imageUrl,_that.imageFile,_that.totalSeats,_that.feedbackForm,_that.registrationDeadLine,_that.joinedUserIds);case _:
  return null;
...
@override@JsonKey(defaultValue: []) List<String> get joinedUserIds {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Program&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.host, host) || other.host == host)&&(identical(other.speaker, speaker) || other.speaker == speaker)&&(identical(other.url, url) || other.url == url)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.time, time) || other.time == time)&&(identical(other.locationType, locationType) || other.locationType == locationType)&&(identical(other.location, location) || other.location == location)&&(identical(other.tag, tag) || other.tag == tag)&&const DeepCollectionEquality().equals(other._skills, _skills)&&(identical(other.eligibility, eligibility) || other.eligibility == eligibility)&&(identical(other.isFree, isFree) || other.isFree == isFree)&&(identical(other.fee, fee) || other.fee == fee)&&(identical(other.offersCertificate, offersCertificate) || other.offersCertificate == offersCertificate)&&(identical(other.offersBadge, offersBadge) || other.offersBadge == offersBadge)&&(identical(other.offersMicroScholarships, offersMicroScholarships) || other.offersMicroScholarships == offersMicroScholarships)&&(identical(other.offersLetterOfRecommendation, offersLetterOfRecommendation) || other.offersLetterOfRecommendation == offersLetterOfRecommendation)&&(identical(other.offersPhysicalSwags, offersPhysicalSwags) || other.offersPhysicalSwags == offersPhysicalSwags)&&(identical(other.offersXleratePoints, offersXleratePoints) || other.offersXleratePoints == offersXleratePoints)&&(identical(other.xpAmount, xpAmount) || other.xpAmount == xpAmount)&&(identical(other.extraReward, extraReward) || other.extraReward == extraReward)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.imageFile, imageFile) || other.imageFile == imageFile)&&(identical(other.totalSeats, totalSeats) || other.totalSeats == totalSeats)&&(identical(other.feedbackForm, feedbackForm) || other.feedbackForm == feedbackForm)&&(identical(other.registrationDeadLine, registrationDeadLine) || other.registrationDeadLine == registrationDeadLine)&&const DeepCollectionEquality().equals(other._joinedUserIds, _joinedUserIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,host,speaker,url,startDate,endDate,time,locationType,location,tag,const DeepCollectionEquality().hash(_skills),eligibility,isFree,fee,offersCertificate,offersBadge,offersMicroScholarships,offersLetterOfRecommendation,offersPhysicalSwags,offersXleratePoints,xpAmount,extraReward,imageUrl,imageFile,totalSeats,feedbackForm,registrationDeadLine,const DeepCollectionEquality().hash(_joinedUserIds)]);
...
/// Create a copy of Program
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? host = null,Object? speaker = freezed,Object? url = freezed,Object? startDate = null,Object? endDate = freezed,Object? time = null,Object? locationType = null,Object? location = null,Object? tag = null,Object? skills = null,Object? eligibility = null,Object? isFree = null,Object? fee = null,Object? offersCertificate = null,Object? offersBadge = null,Object? offersMicroScholarships = null,Object? offersLetterOfRecommendation = null,Object? offersPhysicalSwags = null,Object? offersXleratePoints = null,Object? xpAmount = freezed,Object? extraReward = freezed,Object? imageUrl = null,Object? imageFile = freezed,Object? totalSeats = freezed,Object? feedbackForm = freezed,Object? registrationDeadLine = freezed,Object? joinedUserIds = null,}) {
...
as int?,feedbackForm: freezed == feedbackForm ? _self.feedbackForm : feedbackForm // ignore: cast_nullable_to_non_nullable
as SavedFeedbackForm?,registrationDeadLine: freezed == registrationDeadLine ? _self.registrationDeadLine : registrationDeadLine // ignore: cast_nullable_to_non_nullable
as String?,joinedUserIds: null == joinedUserIds ? _self._joinedUserIds : joinedUserIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
