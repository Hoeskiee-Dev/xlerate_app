...
mixin _$Announcement {
 ...
 String? get id; String get title; String get description; String get date; String get type; String? get imageBase64;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,date,type,imageBase64);

@override
String toString() {
  return 'Announcement(id: $id, title: $title, description: $description, date: $date, type: $type, imageBase64: $imageBase64)';
}
...
@useResult
$Res call({
 String? id, String title, String description, String date, String type, String? imageBase64
});
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? date = null,Object? type = null,Object? imageBase64 = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String title,  String description,  String date,  String type,  String? imageBase64)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.date,_that.type,_that.imageBase64);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String title,  String description,  String date,  String type,  String? imageBase64)  $default,) {final _that = this;
switch (_that) {
case _Announcement():
return $default(_that.id,_that.title,_that.description,_that.date,_that.type,_that.imageBase64);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String title,  String description,  String date,  String type,  String? imageBase64)?  $default,) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.date,_that.type,_that.imageBase64);case _:
  return null;
...
class _Announcement implements Announcement {
  const _Announcement({this.id, required this.title, required this.description, required this.date, required this.type, this.imageBase64});
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? description = null,Object? date = null,Object? type = null,Object? imageBase64 = freezed,}) {
